...
def set_args():
    ...
    parser.add_argument('--model_dir', default="output_dir_lora_glm_2task/", type=str, help='')
    parser.add_argument('--max_len', type=int, default=428, help='')
...
def main():
    ...
    for file in file_list:
        ...
        model.eval()
        model = PeftModel.from_pretrained(model, model_dir, torch_dtype=torch.float32)
